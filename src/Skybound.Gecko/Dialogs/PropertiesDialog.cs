	...
	partial class PropertiesDialog : Form
	{
		...
		protected override bool ProcessDialogKey(Keys keyData)
		{
			if (keyData == Keys.F1)
			{
                ...
                MessageBox.Show(String.Format("Skybound GeckoFX v{0}\r\n\r\n(C) 2008 Skybound Software. All Rights Reserved.\r\nhttp://www.geckofx.org", versionString),
			...
			switch (m.Msg)
			{
				case WM_ERASEBKGND:
					if (Application.RenderWithVisualStyles)
					{
						...
						rend.DrawParentBackground(new DeviceContext(m.WParam), ClientRectangle, this);
