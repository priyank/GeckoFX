...
namespace Skybound.Gecko
{
		...
		//nsIWindowProvider,
	{
		...
		protected override void OnHandleCreated(EventArgs e)
		{
			if (!this.DesignMode)
			{
				...
				// history
                nsISHistory hist = WebNav.GetSessionHistory();
                hist.AddSHistoryListener(this);
		...
		internal class WindowCreator : nsIWindowCreator
		{
		...
		public bool Navigate(string url, GeckoLoadFlags loadFlags, string referrer, byte [] postData, string additionalHeaders)
		{
			...
			if (IsHandleCreated)
			{
				...
				if (!string.IsNullOrEmpty(additionalHeaders))
				{
					...
					if (!additionalHeaders.EndsWith(Environment.NewLine))
						additionalHeaders += Environment.NewLine;
		...
		class ToolTipWindow : Form
		{
			public ToolTipWindow()
			{
                ...
                this.VisibleChanged += (sender, e) => UpdateSize();
	...
	public class GeckoHistoryEventArgs : EventArgs
	{
	...
	public class GeckoCreateWindowEventArgs : EventArgs
	{
