...
namespace Skybound.Gecko
{
	...
	interface nsIWebNavigation
	{
        ...
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(multimarshaler), MarshalCookie = "Skybound.Gecko.nsISHistory")]
    ...
    internal interface nsIDOMHTMLInputElement : nsIDOMHTMLElement
    {
        // nsIDOMNode:
        new void GetNodeName(nsAString aNodeName);
        new void GetNodeValue(nsAString aNodeValue);
        ...
        // nsIDOMHTMLImputElement:
        new void GetDefaultValue(nsAString aNodeValue);
        new void SetDefaultValue(nsAString aNodeValue);
        new bool GetDefaultChecked();
        new void SetDefaultChecked(bool val);
        new nsIDOMNSHTMLElement GetForm();
        new void GetAccept(nsAString aNodeValue);
        new void SetAccept(nsAString aNodeValue);
        new void GetAccessKey(nsAString aNodeValue);
        new void SetAccessKey(nsAString aNodeValue);
        new void GetAlign(nsAString aNodeValue);
        new void SetAlign(nsAString aNodeValue);
        new void GetAlt(nsAString aNodeValue);
        new void SetAlt(nsAString aNodeValue);
        new bool GetChecked();
        new void SetChecked(bool val);
        new bool GetDisabled();
        new void SetDisabled(bool val);
        new long GetMaxLength();
        new void SetMaxLength(long val);
        new void GetName(nsAString aNodeValue);
        new void SetName(nsAString aNodeValue);
        new bool GetReadOnly();
        new void SetReadOnly(bool val);

        new long GetSize();
        new void SetSize(long val);
        new void GetSrc(nsAString aNodeValue);
        new void SetSrc(nsAString aNodeValue);
        new long GetTabIndex();
        new void SetTabIndex(long val);
                                   
        new void GetType(nsAString aNodeValue);
        new void SetType(nsAString aNodeValue);
        new void GetUseMap(nsAString aNodeValue);
        new void SetUseMap(nsAString aNodeValue);
        new void GetValue(nsAString aNodeValue);
        new void SetValue(nsAString aNodeValue);
    ...
    [Guid("c914d7a4-63b3-4d40-943f-91a3c7ab0d4d"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface nsIDOMNSHTMLButtonElement : nsISupports
    {
        new void blur();
        new void focus();
        new void click();
        new void GetType(nsAString aType);
        new void SetType(nsAString aType);
    } ;
	...
	class PRUnicharMarshaler : ICustomMarshaler
	{
		...
		{
            byte[] bytes = Encoding.Unicode.GetBytes(String.Format("{0}\0", ManagedObj));
    ...
    [xpcVersion(0x1080000, 0x1090100, 0x1090200)]
    interface nsIDOMNSElement : ScrollAndClient_nsIDOMNSElement
	{
		nsIDOMNodeList GetElementsByClassName(nsAString classes);
	...
	interface nsIDOMNSElement_01080000
	{
		nsIDOMNodeList GetElementsByClassName(nsAString classes);
		nsIDOMClientRectList GetClientRects();
		nsIDOMClientRect GetBoundingClientRect();
	...
	interface nsIDOMNSElement_01090100
	{
		nsIDOMNodeList GetElementsByClassName(nsAString classes);
		nsIDOMClientRectList GetClientRects();
		nsIDOMClientRect GetBoundingClientRect();
    ...
    interface nsIDOMNSElement_01090200
    {
        nsIDOMNodeList GetElementsByClassName(nsAString classes);
        nsIDOMClientRectList GetClientRects();
        nsIDOMClientRect GetBoundingClientRect();
        ...
        bool mozMatchesSelector(nsAString selector);
    }

    [Guid("c6f1e160-eeeb-404a-98b0-6f1246520b6e"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]    
    interface nsIDOMDOMTokenList
    {
        int GetLength();

        void Item(int index, nsAString _retval);
        bool Contains(nsAString token);
        void Add(nsAString token);
        void Remove(nsAString token);
        bool Toogle(nsAString token);
    
        void ToString(nsAString _retval);
    };
	
    [xpcVersion(0x1080000, 0x1090100)]
	...
	interface nsIDOMClientRect_01080000
	{
		float GetLeft();
		float GetTop();
		float GetRight();
	...
	interface nsIDOMClientRect_01090100
	{
		float GetLeft();
		float GetTop();
		float GetRight();
